<?php 
    ...
    if(isset($_POST["btn_eliminar"])){
        $bar_id=$_POST["pre_id"];
        $sql="DELETE FROM preferencias WHERE pre_id=".$pre_id;
...
<head>
    ...
    <title>Eliminar Preferncias</title>
...
<div class="container">
        <div class="row">
            <div class="col">
                <h1 class="text-center">ELIMINAR PREFERENCIAS</h1>
            </div>
        </div>
        <div class="row border">
            ...
            <div class="form-group">
                <label for="pre_fecha" class="font-weight-bold">Fecha</label><br>
                <span id="pre_fecha"><?php echo $row["pre_fecha"]?></span>
            </div>    
            <div class="form-group">
            <label for="pre_observacion" class="font-weight-bold">Observaciones</label><br>
